...
export const metadata: Metadata = {
  ...
  description: "Free online tool to compress images and videos instantly. Reduce file sizes for JPEG, PNG, WebP, AVIF images and MP4 videos with high quality. No registration required.",
  keywords: [
    "image compression",
    "video compression", 
    "file size reducer",
  ...
  twitter: {
    ...
    title: 'Compression Studio - Free Online Image & Video Compressor',
    description: 'Free online tool to compress images and videos instantly. Reduce file sizes with high quality.',
    images: ['/preview.jpg'],
  ...
  const structuredData = {
    ...
    "@graph": [
        ...
        "potentialAction": [
          {
            ...
            "target": {
              "@type": "EntryPoint",
              "urlTemplate": "https://compression-studio.com/?q={search_term_string}"
            },
      ...
      },
      {
        ...
        "url": "https://compression-studio.com",
        "description": "Professional online tool for compressing images and videos while maintaining quality",
        "offers": {
          "@type": "Offer",
          "price": "0",
          "priceCurrency": "USD"
      ...
      },
      {
        ...
        "sameAs": [
          "https://twitter.com/compressionstudio"
        ]
      }
    ]
  };
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta property="og:image:alt" content="Compression Studio - Free Online Image and Video Compression Tool" />
        <meta name="twitter:image" content="/preview.jpg" />
        <meta name="twitter:image:alt" content="Compression Studio - Free Online Image and Video Compression Tool" />
        {/* LinkedIn specific */}
