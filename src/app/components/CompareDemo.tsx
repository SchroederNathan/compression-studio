...
export function CompareImageDemo({ firstImage, secondImage }: ImageDemoProps) {
  return (
    <div className="flex w-full items-center justify-center px-1 [perspective:800px] [transform-style:preserve-3d] md:px-8">
      <div
        className="w-full rounded-3xl border border-neutral-200 bg-neutral-100 p-1 md:p-4 dark:border-neutral-800 dark:bg-neutral-900"
      >
        <Compare
          ...
          className="w-full rounded-[22px] md:rounded-lg"
          slideMode="drag"
          autoplay={false}
        />
      </div>
